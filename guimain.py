...
# define graph value data
    ...
    def f2():
        ...
        canvas.draw()
# define Space for inserted values
    def f3():
...
# Define round value
    ...
    def f7():
        ...
        canvas.get_tk_widget().place(x=0,y=210)
        canvas.draw()
# Designing value using Label and Text
    val=v.get()
    if (val!=0):
        branch=Toplevel()
        var1=StringVar()
        ...
        if (val==1):
            ...
            Label(branch,text="Prediction Type:").grid(row=1,column=0)
            var2.set(crops[0])
            ...
            Label(branch,text="GW Prediction:").grid(row=9,column=0)
            ...
            Label(branch,text="prediction").grid(row=9,column=2)
        ...
        if (val==2):
            ...
            var1.set(states[0])
            OptionMenu(branch,var1,*states).grid(row=0,column=1)
            Label(branch,text="Choose Types:").grid(row=1,column=0)
            var2.set(crops[0])
            OptionMenu(branch,var2,*crops).grid(row=1,column=1)
        ...
        if (val==3):
            ...
            Label(branch,text="Prediction ").grid(row=4,column=1)
            rowno=5
            e=[]
        ...
        if (val==4):
            ...
            var3.set(gyears[0])
            OptionMenu(branch,var3,*gyears).grid(row=2,column=1)
            Label(branch,text="Type").grid(row=4,column=0)
            Label(branch,text="Prediction ").grid(row=4,column=1)
            rowno=5
            e=[]
        ...
        if (val==5):
            ...
            var1.set(states[0])
            OptionMenu(branch,var1,*states).grid(row=0,column=1)
            Label(branch,text="Choose Prediction Type:").grid(row=1,column=0)
            var2.set(crops[0])
            OptionMenu(branch,var2,*crops).grid(row=1,column=1)
            Label(branch,text="Choose Year:").grid(row=2,column=0)
            var3.set(pyears[0])
            ...
            Label(branch,text="Precipitation:").grid(row=7,column=0)
            Label(branch,text="Potential Evaporation:").grid(row=8,column=0)
            Label(branch,text="Prediction1:").grid(row=9,column=0)
            Label(branch,text="Prediction2:").grid(row=10,column=0)
            Label(branch,text="Prediction3:").grid(row=11,column=0)
            Label(branch,text="Prediction4:").grid(row=12,column=0)
            Label(branch,text="Prediction:",font=('Times',16,'bold italic')).place(x=0,y=300)
            Label(branch,text="degree Celsius").grid(row=4,column=2)
            Label(branch,text="degree Celsius").grid(row=5,column=2)
            Label(branch,text="%").grid(row=6,column=2)
            Label(branch,text="mm").grid(row=7,column=2)
            Label(branch,text="mm").grid(row=8,column=2)
            Label(branch,text="").grid(row=9,column=2)
            Label(branch,text="").grid(row=10,column=2)
            Label(branch,text="").grid(row=11,column=2)
            Label(branch,text="").grid(row=12,column=2)
            Label(branch,text="",font=('Times',16,'bold italic')).place(x=0,y=350)
            eltemp=Entry(branch,justify='center')
            eltemp.grid(row=4,column=1)
            ehtemp=Entry(branch,justify='center')
            ehtemp.grid(row=5,column=1)
        ...
        if (val==6):
            branch.geometry('640x730')
            Label(branch,text="Choose Prediction:").grid(row=1,column=0)
            var2.set(crops[0])
            OptionMenu(branch,var2,*crops).grid(row=1,column=1)
            Label(branch,text="Choose Year:").grid(row=2,column=0)
            var3.set(pyears[0])
        ...
        if (val==7):
            ...
            var3.set(pyears[0])
            OptionMenu(branch,var3,*pyears).grid(row=2,column=1)
            Label(branch,text="Pollutants Level").grid(row=4,column=0)
            Label(branch,text="Prediction ").grid(row=4,column=1)
            rowno=5
            e=[]
            for i in range(len(crops)):
...
root=Tk()
root.state('zoomed')
root.title('Air Quality Pollutants Level Prediction')
#image = PIL.Image.open('background.jpg')
#photo_image = PIL.ImageTk.PhotoImage(image)
#Label(root, image = photo_image).pack()

Label(root,text="Air Quality Pollutants Level Prediction",font=('Papyrus',20)).place(x=300,y=20)
v=IntVar()
Label(root,text="Access existing data:",font=('Perpetua',18)).place(x=20,y=100)

Radiobutton(root,text="Bar graph of prediction of a Air Quality Level in a state over all years",variable=v,value=2,font=('Garamond',16)).place(x=20,y=210,anchor=W)
Radiobutton(root,text="States which has highest Air Quality each year",variable=v,value=3,font=('Garamond',16)).place(x=20,y=260,anchor=W)
Radiobutton(root,text="Air Quality Level with highest Prediction in a state each year",variable=v,value=4,font=('Garamond',16)).place(x=20,y=310,anchor=W)
Label(root,text="Predict future data:",font=('Perpetua',18)).place(x=20,y=380)

Radiobutton(root,text="Predict which state will have the highest Air Quality Pollutants",variable=v,value=6,font=('Garamond',16)).place(x=20,y=490,anchor=W)
Radiobutton(root,text="Predict which Air Quality Pollutants will have highest Prediction",variable=v,value=7,font=('Garamond',16)).place(x=20,y=540,anchor=W)
